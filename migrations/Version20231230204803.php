 ...
 */
final class Version20231230204803 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318C2B5C9234 FOREIGN KEY (black_player_fk_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318CF5E6D29E FOREIGN KEY (white_player_fk_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
